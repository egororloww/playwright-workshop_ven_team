import { BookingListType } from '@/services/types/bookings';
import { useOutletContext } from 'react-router-dom';
import { StatusBadge, Table, TableLink, TableResults, TableWrapper, Typography } from '@/components';
...
export const CustomerBookings = (): JSX.Element => {
  const { bookingsList }: { bookingsList: BookingListType } = useOutletContext();
